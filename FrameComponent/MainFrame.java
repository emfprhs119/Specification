...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		*/
		...
		viewManager = new ViewManager(contentPane, masterPanel, frameLabel); // 뷰
																							// 관리
		// function 클래스 생성
		...
		contentPane.add(viewManager.getProductView().getSumTaxBottom());
		...
		// 파일명,페이지명 레이블 추가
		contentPane.add(frameLabel.getDocument());
